      ...
      <div className="customize-modal" onClick={(e) => e.stopPropagation()}>
        <div className="customize-modal-content">
          ...
          <div className="customize-modal-header">
            <h2 className="customize-modal-title">Customise {item.name}</h2>
          ...
          <div className="customize-modal-item-info">
            <span className="customize-modal-item-name">{item.name}</span>
          ...
          <div className="customize-modal-scrollable">
            ...
            {item.variations && item.variations.length > 0 && (
              <div className="customize-modal-section">
                <h3 className="customize-modal-section-title">Variations</h3>
                      ...
                      {variation.values && variation.values.map((value, valueIndex) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {optionPrice > 0 && (
                              <span className="customize-variation-price">+₹{optionPrice.toFixed(2)}</span>
                            )}
                            {optionPrice === 0 && (
                              <span className="customize-variation-price">+₹0</span>
                            )}
                          </label>
                        );
                      })}
            ...
            <PriceBreakdown
              ...
              variationsTotal={priceCalculation.variationsTotal}
