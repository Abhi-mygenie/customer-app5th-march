...
| [CR-2026-09-12-003](./CR-2026-09-12-003-otp-echo-removal-persistent-otp-store/IMPACT_ANALYSIS.md) | Remove OTP echo + persistent throttled OTP store + SMS provider (GAP-003) | 🔒 **DEFERRED TO WAVE 2 — 2026-09-13** (was Wave 1b). Blocked on CR-017 first. | **P0 / CRITICAL** | **2** (deferred) | CR-017 must close → then re-open CR-003 Planning |
| [CR-2026-09-12-004](./CR-2026-09-12-004-cors-lockdown-rate-limit-middleware/IMPACT_ANALYSIS.md) | CORS hybrid static+regex allow-list + auth rate-limit + middleware stack (GAP-005/004) | ✅ **Wave 1a · IMPLEMENTATION_PLAN WRITTEN 2026-09-13** — IMPLEMENTATION_PLAN.md ready (6 surgical server.py edits). Awaiting owner "go" for Role 3. | **P0 / CRITICAL** | **1a** | none — owner drives next session |
| [CR-2026-09-12-005](./CR-2026-09-12-005-ci-gate-contract-snapshots/IMPACT_ANALYSIS.md) | CI gate + API contract snapshots + smoke tests on UAT Mongo (GAP-009) | 🚧 **Wave 1a · IMPLEMENTED 2026-09-13 — QA-pending** — 22 tests (14 contract + 8 smoke) all PASS locally. Snapshots generated. Awaiting QA. | P1 / MEDIUM | **1a** (Phase 1) | none — owner drives next session |
| CR-2026-07-03-007 (F-07) | `.env.example` + purge dead FE env keys + rotation checklist — **folded into CR-007** | ✅ **Wave 1a · IMPLEMENTATION_PLAN WRITTEN 2026-09-13** — IMPLEMENTATION_PLAN_F07_2026-09-13.md ready. Awaiting owner "go" for Role 3. | P1 / LOW | **1a** | none — owner drives next session |
...
| [CR-2026-09-12-017](./CR-2026-09-12-017-crm-sms-finalization-for-otp/INTAKE_DOC.md) | **CRM SMS finalization for OTP** — prereq for CR-003 | 🔒 **DEFERRED TO WAVE 2 — 2026-09-13** (was Wave 1b). Intake done. Blocked on owner supplying CRM contract + DLT + SMS template + sender ID + UAT phones (§7). | **P0 / HIGH** | **2** (deferred) | supply §7 items → owner assigns Role 2 (Planning) |
