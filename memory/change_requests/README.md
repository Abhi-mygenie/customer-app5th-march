...
| [CR-2026-09-12-004](./CR-2026-09-12-004-cors-lockdown-rate-limit-middleware/IMPACT_ANALYSIS.md) | CORS hybrid static+regex allow-list + auth rate-limit + middleware stack (GAP-005/004) | ✅ **Wave 1a · IA APPROVED 2026-09-12 · IA GATE CLOSED 2026-09-13** — All 8 D-004-* + 7 A-N decisions locked. Next: IMPLEMENTATION_PLAN. | **P0 / CRITICAL** | **1a** | none — owner drives next session |
| [CR-2026-09-12-005](./CR-2026-09-12-005-ci-gate-contract-snapshots/IMPACT_ANALYSIS.md) | CI gate + API contract snapshots + smoke tests on UAT Mongo (GAP-009) | ✅ **Wave 1a · IA APPROVED 2026-09-12 · IA GATE CLOSED 2026-09-13** — Gate 2 closed. Next: IMPLEMENTATION_PLAN. | P1 / MEDIUM | **1a** (Phase 1) | none — owner drives next session |
| CR-2026-07-03-007 (F-07) | `.env.example` + purge dead FE env keys + rotation checklist — **folded into CR-007** | ✅ **Wave 1a · IA APPROVED 2026-09-12 · IA GATE CLOSED 2026-09-13** — all decisions frozen. Next: IMPLEMENTATION_PLAN. | P1 / LOW | **1a** | none — owner drives next session |
