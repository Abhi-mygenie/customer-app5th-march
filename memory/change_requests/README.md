...
| [CR-2026-07-03-004](./CR-2026-07-03-004-frontend-fetch-timeouts/CR.md) | Frontend fetch timeouts + AbortController + error UI | 📋 PLANNED (all 5 owner decisions ✅, design agent ✅, INV-001 cleared; ready for Role 3) | P2 | 7 FE (~80 LOC net) | ~4 hrs impl + owner smoke | say "**proceed with CR-004**" |
