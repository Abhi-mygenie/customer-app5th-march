...
- `REACT_APP_BACKEND_URL=https://app-13-april.preview.emergentagent.com` (WRONG)
- Should be `https://app-13-april.preview.emergentagent.com` (CORRECT)
- API calls went to non-existent server → returned 404 HTML page

**Fix Applied:**
```bash
# Updated /app/frontend/.env
REACT_APP_BACKEND_URL=https://app-13-april.preview.emergentagent.com
```

**Verification:**
```bash
# Before fix (wrong URL)
curl -s https://app-13-april.preview.emergentagent.com/api/auth/login
→ "404 page not found"
