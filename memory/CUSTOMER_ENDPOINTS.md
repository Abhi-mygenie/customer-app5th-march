...
**Base URL:** `https://4a7e2250-5b49-41e3-a2cb-0b90056dac03.preview.emergentagent.com`
...
**cURL:**
```bash
curl -X POST "https://4a7e2250-5b49-41e3-a2cb-0b90056dac03.preview.emergentagent.com/api/auth/check-customer" \
...
**cURL (Password Login):**
```bash
curl -X POST "https://4a7e2250-5b49-41e3-a2cb-0b90056dac03.preview.emergentagent.com/api/auth/login" \
  -H "Content-Type: application/json" \
  -d '{
...
**cURL:**
```bash
curl -X POST "https://4a7e2250-5b49-41e3-a2cb-0b90056dac03.preview.emergentagent.com/api/auth/send-otp" \
  -H "Content-Type: application/json" \
  -d '{
    "phone": "+919579504871",
    "restaurant_id": "478"
...
**cURL:**
```bash
curl -X POST "https://4a7e2250-5b49-41e3-a2cb-0b90056dac03.preview.emergentagent.com/api/auth/set-password" \
  -H "Content-Type: application/json" \
  -d '{
    "phone": "+919876543210",
    "password": "MyPass123",
...
**cURL:**
```bash
curl -X POST "https://4a7e2250-5b49-41e3-a2cb-0b90056dac03.preview.emergentagent.com/api/auth/verify-password" \
  -H "Content-Type: application/json" \
  -d '{
    "phone": "+919579504871",
    "password": "Qplazm@10",
...
**cURL:**
```bash
curl -X POST "https://4a7e2250-5b49-41e3-a2cb-0b90056dac03.preview.emergentagent.com/api/auth/reset-password" \
  -H "Content-Type: application/json" \
  -d '{
    "phone": "+919579504871",
...
**cURL:**
```bash
curl -X GET "https://4a7e2250-5b49-41e3-a2cb-0b90056dac03.preview.emergentagent.com/api/auth/me" \
...
**cURL:**
```bash
curl -X GET "https://4a7e2250-5b49-41e3-a2cb-0b90056dac03.preview.emergentagent.com/api/customer/profile" \
  -H "Authorization: Bearer eyJhbGciOiJI..."
```
...
**cURL:**
```bash
curl -X PUT "https://4a7e2250-5b49-41e3-a2cb-0b90056dac03.preview.emergentagent.com/api/customer/profile" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer eyJhbGciOiJI..." \
  -d '{
    "name": "John Updated",
...
**cURL:**
```bash
curl -X GET "https://4a7e2250-5b49-41e3-a2cb-0b90056dac03.preview.emergentagent.com/api/customer/orders?limit=10&skip=0" \
  -H "Authorization: Bearer eyJhbGciOiJI..."
```
