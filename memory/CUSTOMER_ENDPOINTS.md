...
**Base URL:** `https://customer-app-march-2.preview.emergentagent.com`
...
**cURL:**
```bash
curl -X POST "https://customer-app-march-2.preview.emergentagent.com/api/auth/check-customer" \
...
**cURL (Password Login):**
```bash
curl -X POST "https://customer-app-march-2.preview.emergentagent.com/api/auth/login" \
  -H "Content-Type: application/json" \
  -d '{
...
**cURL:**
```bash
curl -X POST "https://customer-app-march-2.preview.emergentagent.com/api/auth/send-otp" \
  -H "Content-Type: application/json" \
  -d '{
    "phone": "+919579504871",
    "restaurant_id": "478"
...
**cURL:**
```bash
curl -X POST "https://customer-app-march-2.preview.emergentagent.com/api/auth/set-password" \
  -H "Content-Type: application/json" \
  -d '{
    "phone": "+919876543210",
    "password": "MyPass123",
...
**cURL:**
```bash
curl -X POST "https://customer-app-march-2.preview.emergentagent.com/api/auth/verify-password" \
  -H "Content-Type: application/json" \
  -d '{
    "phone": "+919579504871",
    "password": "Qplazm@10",
...
**cURL:**
```bash
curl -X POST "https://customer-app-march-2.preview.emergentagent.com/api/auth/reset-password" \
  -H "Content-Type: application/json" \
  -d '{
    "phone": "+919579504871",
...
**cURL:**
```bash
curl -X GET "https://customer-app-march-2.preview.emergentagent.com/api/auth/me" \
...
**cURL:**
```bash
curl -X GET "https://customer-app-march-2.preview.emergentagent.com/api/customer/profile" \
  -H "Authorization: Bearer eyJhbGciOiJI..."
```
...
**cURL:**
```bash
curl -X PUT "https://customer-app-march-2.preview.emergentagent.com/api/customer/profile" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer eyJhbGciOiJI..." \
  -d '{
    "name": "John Updated",
...
**cURL:**
```bash
curl -X GET "https://customer-app-march-2.preview.emergentagent.com/api/customer/orders?limit=10&skip=0" \
  -H "Authorization: Bearer eyJhbGciOiJI..."
```
...
**cURL:**
```bash
curl -X GET "https://customer-app-march-2.preview.emergentagent.com/api/customer/points?limit=20" \
  -H "Authorization: Bearer eyJhbGciOiJI..."
```
...
**cURL:**
```bash
curl -X GET "https://customer-app-march-2.preview.emergentagent.com/api/customer/wallet" \
  -H "Authorization: Bearer eyJhbGciOiJI..."
```
...
**cURL:**
```bash
curl -X GET "https://customer-app-march-2.preview.emergentagent.com/api/customer/coupons" \
  -H "Authorization: Bearer eyJhbGciOiJI..."
```
...
**cURL:**
```bash
curl -X GET "https://customer-app-march-2.preview.emergentagent.com/api/customer-lookup/478?phone=9579504871"
```
...
```bash
curl -X GET "https://customer-app-march-2.preview.emergentagent.com/api/air-bnb/get-order-details/12345"
```
...
**cURL (via our backend):**
```bash
curl -X GET "https://customer-app-march-2.preview.emergentagent.com/api/table-config" \
...
**cURL:**
```bash
curl -X GET "https://customer-app-march-2.preview.emergentagent.com/api/loyalty-settings/478"
```
